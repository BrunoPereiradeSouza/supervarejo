...
urlpatterns = [
    ...
    path('contato/', views.contato_criar, name='contato'),
    ...
    path('contato/listar/', views.contato_listar, name='contato_listar'),
    path('contato/detalhe<int:id>', views.contato_detalhe, name='contato_detalhe')
]
